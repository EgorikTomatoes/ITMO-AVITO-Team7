...
== 10. Оценка времени эксперимента
Финальные параметры:
...
== 11. Влияние параметров на подходы
...
// Раскомментируйте после добавления model_quality_r2.png в корень проекта:
// #figure(image("model_quality_r2.png"))
